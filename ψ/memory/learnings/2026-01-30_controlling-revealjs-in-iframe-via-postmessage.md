---
title: # Controlling Reveal.js in iframe via postMessage
tags: [reveal.js, iframe, postMessage, keyboard-events, presentation, web-api, cross-origin, double-advance-bug]
created: 2026-01-30
...
Without disabling Reveal.js built-in handlers, you get the "double-advance" bug where pressing arrow keys causes slides to jump 2 at a time (1→3→5→7).
